...
import { ChevronUpDown, Loader2, PlusCircle } from 'lucide-react'
...
export functon ProjectSwitcher() {
        ...
        <DropdownMenu>
            <DropdownMenuTrigger className="flex w-[168px] items-center gap-2 rounded p-1 text-sm font-medium outline-none focus-visible:ring-2 focus-visible:ring-primary">
                ...
                {isLoading ? (
                    ...
                    <ChevronUpDown className="ml-auto size-4 shrink-0 text-muted-foreground" />
                )}
            </DropdownMenuTrigger>
            <DropdownMenuContent
                align="end"
